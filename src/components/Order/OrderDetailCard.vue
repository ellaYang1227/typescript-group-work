            ...
            <ul class="list-group list-group-flush">
                ...
                >
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item px-0 pt-0 pb-4 pb-lg-6">
                            ...
                            >
                                ...
                                <ul class="list-unstyled mb-0">
                                    <li
                                        v-if="isHistory"
                                        class="text-neutral-80 mb-3"
                                    >
                                        預訂參考編號：{{ orderDetail._id }}
                                    </li>
                                    <li
                                        class="fw-bold"
                                        :class="isHistory ? 'mb-3' : 'mb-4'"
                                    >
                                        <h6
                                        ...
                                        >
                                            {{ orderDetail.roomId.name
                                                ...
                                                <div
                                                    class="vr bg-neutral-60 mx-3"
                                                ></div>
                                                住宿人數：{{
                                                    orderDetail.peopleNum
                                                }}
                                                位</template
                                            >
                                        </h6>
                                    ...
                                    >
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div
                                                class="customize-vr bg-neutral-60"
                                            ></div>
                                            退房：{{
                                                dateTransform(
                                                    orderDetail.checkOutDate
                        ...
                        <!-- 提供細項 -->
                        <li
                            class="list-group-item px-0 pt-4 pt-lg-6 pb-0"
                            v-if="!isHistory"
                        >
