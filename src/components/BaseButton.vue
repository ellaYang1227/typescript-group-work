...
<template>
  <a v-if="props.href" :href="props.href" :target="props.target" :disabled="props.disabled" class="baseButton">
    <span class="baseButton__content"><slot /></span>
  </a>
  <router-link v-else-if="props.to" :to="props.to" :disabled="props.disabled" class="baseButton">
    <span class="baseButton__content"><slot /></span>
  </router-link>
